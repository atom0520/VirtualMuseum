...
public class ThirdPersonController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Input.GetButtonDown("Jump") && !jumping && isControllable)
        {
        ...
        if (animator)
        {
            ...
            {
                //Debug.Log("_characterState == CharacterState.Jumping!" );
                ...
                else
                {
                    ...
                    animator.speed = Mathf.Max(1f,-landAnimationSpeed);
                    //_animation[jumpPoseAnimation.name].wrapMode = WrapMode.ClampForever;
                    //_animation.CrossFade(jumpPoseAnimation.name);
                    //animator.SetBool("isRunning", true);
                }
            ...
            {                
                ...
                {
                    _characterState = CharacterState.Idle;
                    //Debug.Log("_characterState = CharacterState.Idle!");
                    //_animation.Stop();
                ...
                else
                {
                    ...
                    if(runTrigger)
                    {
                        ...
                        animator.speed = Mathf.Clamp(controller.velocity.magnitude, 0.0f, runMaxAnimationSpeed);
                        animator.SetBool("isRunning", true);
                        animator.SetBool("isWalking", false);
                    ...
                    else if (_characterState == CharacterState.Trotting)
                    {
                        ...
                        animator.speed = Mathf.Clamp(controller.velocity.magnitude, 0.0f, trotMaxAnimationSpeed);
                        animator.SetBool("isRunning", true);
                        animator.SetBool("isWalking", false);
                    ...
                    else if (_characterState == CharacterState.Walking)
                    {
                        ...
                        animator.speed = Mathf.Clamp(controller.velocity.magnitude, 0.0f, walkMaxAnimationSpeed);
                        animator.SetBool("isWalking", true);
                        animator.SetBool("isRunning", false);
